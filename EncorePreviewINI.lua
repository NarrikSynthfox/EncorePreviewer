...
gfx.init("Encore Preview (INI)", 640, 480, 0, 200, 200)
...
instrumentTracks={
	{"Drums",findTrack("PAD DRUMS")},
	{"Bass",findTrack("PAD BASS")},
	{"Guitar",findTrack("PAD GUITAR")},
	{"Keys",findTrack("PAD KEYS")},
	{"Vocals",findTrack("PAD VOCALS")},
	{"Classic Drums",findTrack("PART DRUMS")},
	{"Classic Bass", findTrack("PART BASS")},
	{"Classic Guitar", findTrack("PART GUITAR")},
	{"Classic Keys", findTrack("PART KEYS")}
}
...
keyBinds={
	...
	[91]=function()
		if inst==1 then inst=9 else inst=inst-1 end
		midiHash=""
		updateMidi()
	end,
	[93]=function()
		if inst==9 then inst=1 else inst=inst+1 end
		midiHash=""
		updateMidi()
	end,
	[43]=function()
